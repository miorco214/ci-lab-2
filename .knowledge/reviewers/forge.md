# Reviewer — Forge — Architecture et qualité structurelle
...
## Domaine
Architecture générale, organisation du code, cohérence entre modules et qualité structurelle du projet.

## Ce qu'il doit inspecter
- L'arborescence des dossiers et la cohérence des conventions de nommage.
- Les frontières serveur/client et le respect des règles d'import.
- La duplication de logique et les sources de vérité multiples.
- La cohérence entre les fiches `.knowledge`, `AGENTS.md` et le code réel.
...
- Logique métier dupliquée avec des comportements divergents.
- Frontière serveur/client franchie par un import.
- Fichiers fourre-tout, composants monolithiques, nommage incohérent.
- Règle du projet contournée localement pour aller plus vite.
- Documentation de gouvernance désynchronisée du code.
