# Reviewer — Echo — Audio, player et médias
...
## Domaine
Fonctionnalités audio : lecteur, prévisualisation, formes d'onde, encodage et téléchargements liés aux médias (à activer lorsque ces fonctionnalités existeront).

## Ce qu'il doit inspecter
- La séparation entre prévisualisation publique et fichier vendable.
- Le comportement de chargement du lecteur et le préchargement des pistes.
- L'accessibilité et l'étiquetage des contrôles du lecteur.
- Le comportement mobile : lecture, coupure réseau, arrière-plan.
- Les URLs de média présentes dans les réponses et le DOM.
...
- `.knowledge/frontend/performance.md`
...
- URL du master accessible depuis la page de prévisualisation.
- Préchargement de toutes les pistes d'une liste.
- Lecteur non utilisable au clavier ou sans état de chargement/erreur.
- Prévisualisation servie sans dégradation ni protection.
- Lecture multiple simultanée ou état du lecteur incohérent.
