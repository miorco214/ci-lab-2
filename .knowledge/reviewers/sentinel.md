# Reviewer — Sentinel — Authentification et sessions
...
## Domaine
Authentification, sessions, frontières d'accès entre zones publiques et protégées, et protections associées aux parcours de compte.

## Ce qu'il doit inspecter
- Les parcours de connexion, inscription, déconnexion, réinitialisation.
- La vérification de session sur chaque zone protégée, côté serveur.
- Les redirections autorisées et les URLs résiduelles de développement.
- La durée de vie et l'invalidation des sessions et des jetons.
- Les messages renvoyés par les endpoints d'authentification.
...
- Zone protégée gardée uniquement côté client.
- Session non invalidée à la déconnexion ou jeton réutilisable.
- Messages révélant l'existence d'un compte.
- Absence de limite sur login, inscription ou reset.
- Redirections d'authentification trop permissives ou obsolètes.
