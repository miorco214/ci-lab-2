# Reviewer — Prism — Données personnelles et confidentialité
...
## Domaine
Exposition des données personnelles, minimisation, collecte, conservation et cohérence avec les principes de confidentialité présents dans les documents de référence.

## Ce qu'il doit inspecter
- L'inventaire des données personnelles collectées et leur finalité.
- Les durées de conservation et les mécanismes de suppression.
- Les données personnelles transmises à des tiers.
- Les parcours d'accès, d'export et de suppression de compte.
...
- `.knowledge/compliance/data-residency.md`
...
- Champ personnel collecté sans finalité justifiée.
- Absence de durée de conservation ou de suppression effective.
- Donnée personnelle exposée dans une réponse, un log ou un événement.
- Partage avec un tiers non inventorié.
- Absence de parcours de suppression de compte.
