# Reviewer — Ledger — Commerce, licences et paiements
...
## Domaine
Fonctionnalités liées aux commandes, licences, prix, paiements et logique commerciale (à activer lorsque ces fonctionnalités existeront).

## Ce qu'il doit inspecter
- La source de vérité des prix et des droits accordés.
- Les transitions d'état de commande, de licence et de remboursement.
- Le traitement des événements de paiement et leur idempotence.
- La correspondance entre ce qui est payé et ce qui est débloqué.
...
- `.knowledge/architecture/saas-patterns.md`
- `.knowledge/architecture/integrations.md`
...
- Prix ou droits déterminés à partir d'une valeur envoyée par le client.
- Droit accordé sur la base d'une redirection de succès plutôt que d'un
  événement serveur vérifié.
- Double traitement d'un événement de paiement.
- Licence non vérifiée au moment du téléchargement.
- Absence de trace auditable sur une opération financière.
